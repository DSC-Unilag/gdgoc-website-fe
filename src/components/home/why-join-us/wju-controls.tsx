...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="w-14 h-14 border-[3px] border-solid border-white rounded-full flex justify-center items-center cursor-pointer transition-[opacity] ease-in-out duration-300 disabled:opacity-30 hover:opacity-80"
      type="button"
      {...restProps}
    >
